...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo site_url('admin/soal'); ?>">Pilih Mata Pelajaran</a>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Pilih mata pelajaran dulu</h5>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-mytable" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <a class="btn btn-primary btn-xs" href="<?php echo site_url('admin/soal/mapel').'?id_mapel='.hash_id($value->id); ?>">
