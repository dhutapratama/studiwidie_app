...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Tabel User Administrator</h2>
        <ol class="breadcrumb">
            <li>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Administrator adalah user dengan hak akses tertinggi</h5>
                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-mytable" >
                        ...
                        <tbody>
                            <?php foreach ($get_administrator as $key => $value) { ?>
                            <tr>
                                <td><?php echo $value->id; ?></td>
                                <td><?php echo $value->username; ?></td>
                                <td class="center">
                                    <a class="btn btn-warning btn-xs" href="<?php echo site_url('admin/administrator/edit').'?id='.hash_id($value->id); ?>">
                                        <i class="fa fa-pencil"></i> Edit
                                    </a>
                                    <a class="btn btn-danger btn-xs" href="<?php echo site_url('admin/administrator/delete').'?id='.hash_id($value->id); ?>">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="ibox-title">
                                <h5>TAMBAH <small>USER ADMINISTRATOR</small></h5>
                            </div>
                            <div class="ibox-content">
                                <form method="post" class="form-horizontal" action="<?php echo site_url('admin/administrator/add'); ?>">
