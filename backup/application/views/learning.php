      ...
      <section id="main-content">
          <section class="wrapper">
		  		<div class="row mt">
                      ...
                      <h4><i class="fa fa-angle-right"></i> DATA LEARNING</h4>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tbody>
                                <?php foreach ($learning as $value) { ?>
                              <tr>
                                  <td><?php echo $value->id_learning; ?></td>
                                  <td><?php echo $value->mapel; ?></td>
                                  <td><?php echo $value->materi; ?></td>
                                  <td class="numeric">
                                    <a class="btn btn-primary btn-xs" href="<?php echo site_url("admin/learning/edit/".$value->id_learning);?>"><i class="fa fa-pencil"></i></a>
                                    <a class="btn btn-danger btn-xs" href="<?php echo site_url("admin/learning/delete/".$value->id_learning);?>"><i class="fa fa-trash-o"></i></a>
                                  </td>
                              </tr>
                              <?php } ?>
                              </tbody>
