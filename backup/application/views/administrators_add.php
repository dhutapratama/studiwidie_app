  ...
  <div class="row mt">
    <div class="col-lg-12">
      <div class="form-panel">
        <h4 class="mb"><i class="fa fa-angle-right"></i> TAMBAH USER ADMINISTRATOR</h4>
        <form class="form-horizontal style-form" method="post" action="<?php echo site_url("admin/administrator/add/do"); ?>">
          ...
          <div class="form-group">
            <label class="col-sm-3 col-sm-3 control-label">RE-PASSWORD</label>
            <div class="col-sm-9">
